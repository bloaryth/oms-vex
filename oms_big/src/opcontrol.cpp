  ...
  **/
  ...
  while (true) {
    ...
    if (master.get_digital(DIGITAL_L2)) {
      ...
      if(left_arm_motor.get_position()>=-1550.0&&left_arm_motor.get_position()<=-650.0)arm_power=-2;
    else arm_power = 0;
		}
    ...
    pros::lcd::print(5, "CLAW_MOTOR position: %d", claw_motor.get_position());
